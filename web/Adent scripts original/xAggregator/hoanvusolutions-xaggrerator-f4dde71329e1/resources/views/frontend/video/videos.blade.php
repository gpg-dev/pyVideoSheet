...
<div class="content">
    <div class="container">
            ...
            <div class="col-sm-4 col-lg-3" >
                <div class="box-porn">
                    <div class="dv_adv_control">
                        <?php if(strpos($ad_video[$element]->content, 'http') !== false && strpos($ad_video[$element]->content, 'http') == 0){ ?>
                        <img src="<?php echo $ad_video[$element]->content; ?>" alt="<?php echo $ad_video[$element]->name; ?>" style="width: 100%;"/>
                        <?php }else{ ?>
                        <?php echo $ad_video[$element]->content; ?>
                        <?php } ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="box-porn">
                    <a href="<?php echo URL::to('/video/' . $video->id); ?>" target="_blank">
                        <div class="img-porn">
                            <img src="{{$video->image}}" class="on-error-img">
                        </div>
                        <div class="text-porn">
                            <h5>
                            ...
                            <div class="bottom-product">
                                <div class="sourch-product"><?php echo $video->getCatName(); ?></div>
        ...
        <?php if($element < count($ad_video)){ ?>
            ...
            <div class="col-sm-4 col-lg-3" >
                <div class="box-porn">
                    <?php if(strpos($ad_video[$element]->content, 'http') !== FALSE || strpos($ad_video[$element]->content, 'base64') !== FALSE){ ?>
                    <div class="dv_adv_control">
                        <img src="<?php echo $ad_video[$element]->content; ?>" alt="<?php echo $ad_video[$element]->name; ?>" style="width: 100%;"/>
                    </div>
                    <?php } ?>
...
@section('script')
    <script>
        ...
        $(".on-error-img").on("error", function(){
            $(this).attr('src', '/uploads/images/noimage.jpg');
        });
    </script>
@endsection