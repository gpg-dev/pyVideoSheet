...
<div id="content" class="main-container">
	...
	$result = $mysqli->query("SELECT * FROM favip LEFT JOIN".
		" LEFT JOIN categories ON posts.catid = categories.id".
		" posts ON favip.postid=posts.id WHERE favip.uid=$Uid AND posts.active=1 ORDER BY favip.id DESC LIMIT $start, 20");
