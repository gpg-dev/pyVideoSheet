...
<div class="page-title"><h1>Your Gallery</h1></div>

<div id="content" class="pull-container">

<?php

	$result = $mysqli->query("SELECT * FROM posts WHERE uid=$Uid AND active=1 ORDER BY id DESC LIMIT 0, 20");
...
<?php } ?>
		...
		<nav id="page-nav">
  			<a href="data_your_posts.php?id=<?php echo $Uid;?>&page=2"></a>
		</nav>
