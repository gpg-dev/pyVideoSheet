...
<div class="page-title"><h1>Video Gallery</h1></div>

<div id="content" class="pull-container">

<?php

	$result = $mysqli->query("SELECT * FROM posts WHERE type=2 AND active=1 ORDER BY id DESC LIMIT 0, 20");
...
?>
               ...
               <div class="play-button"><a href="post-<?php echo $row['id'];?>-<?php echo $PageLink;?>.html" target="_self"><span class="fa fa-video-camera"></span> Play</a></div>
...
<a class="social-icons pinterest-button fa fa-pinterest page-social pull-left"  href="javascript:void(0);" onclick="popup('//pinterest.com/pin/create%2Fbutton/?url=http://<?php echo $SiteLink;?>/post-<?php echo $PostId;?>-<?php echo $PageLink;?>.html')"></a>
...
<?php } ?>
		...
		<nav id="page-nav">
  			<a href="data_videos.php?page=2"></a>
		</nav>
