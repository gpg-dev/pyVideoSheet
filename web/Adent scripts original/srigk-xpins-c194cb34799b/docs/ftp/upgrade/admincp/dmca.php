...
<div class="page-header">
  <h3>DMCA <small>Update DMCA page here</small></h3>
</div>
...
if($Pages = $mysqli->query("SELECT * FROM pages WHERE id='4'")){
...
<form id="updatePages" action="update_dmca_page.php" method="post">
