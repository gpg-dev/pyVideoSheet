...
<div class="page-header">
  <h3>Users <small>Manage your website users</small></h3>
</div>
...
// How many adjacent pages should be shown on each side?
	...
	$query = $mysqli->query("SELECT COUNT(*) as num FROM users ORDER BY id DESC");
	...
	if($page) 
 	...
 	/* Get data. */
	$result = $mysqli->query("SELECT * FROM users ORDER BY id DESC LIMIT $start, $limit");
	...
	$q= $mysqli->query("SELECT * FROM users ORDER BY id DESC limit $start,$limit");
...
?>        
            ...
            <tr class="btnDelete" data-id="<?php echo $Row['id'];?>">
				<td><a href="../profile-<?php echo $Row['id'];?>-<?php echo $UserLink;?>.html" target="_blank">      
                
         <?php if (empty($Avatar)){ ?>    
    
    	<img src="../templates/<?php echo $Settings['template'];?>/images/default-avatar.png" width="50" height="50" alt="<?php echo $User;?>" class="img-responsive"/>
    
		<?php }else{?>

		<img src="timthumb.php?src=http://<?php echo $SiteLink;?>/avatars/<?php echo $Avatar;?>&amp;h=50&amp;w=50&amp;q=100" alt="<?php echo $User;?>" class="img-responsive"/>

		<?php }?>
                
                </a></td>
                
                <td><a href="../profile-<?php echo $Row['id'];?>-<?php echo $UserLink;?>.html" target="_blank"><?php echo ucfirst($Row['username']);?></a></td>

                <td><a href="../profile-<?php echo $Row['id'];?>-<?php echo $UserLink;?>.html" target="_blank"><?php echo ucfirst($Row['full_name']);?></a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-danger"><small>Please not that all the posts, comments posted by this user will also be deleted.</small></p>
