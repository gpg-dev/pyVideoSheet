...
<?php
	...
	$result = $mysqli->query("SELECT * FROM favip LEFT JOIN posts ON favip.postid=posts.id WHERE favip.uid=$Uid AND posts.active=1 ORDER BY favip.id DESC LIMIT 0, 20");
