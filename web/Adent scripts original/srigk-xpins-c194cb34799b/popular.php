...
<div class="page-title"><h1>What's Popular</h1></div>
...
<div id="content" class="pull-container">
	...
	$result = $mysqli->query("SELECT * FROM posts WHERE active=1 ORDER BY tot DESC LIMIT 0, 20");
	$query = $sqlGetProduct("", 'tot');
...
<nav id="page-nav">
	<a href="data_popular.php?page=2"></a>
</nav>
