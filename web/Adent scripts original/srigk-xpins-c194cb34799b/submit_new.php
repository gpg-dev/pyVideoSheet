						...
						<div class="the-form">
							...
							<form id="postSubmitter" action="submit_post.php" enctype="multipart/form-data" method="post">
								...
								<div class="form-group">
									...
									<input type="text" onchange="getWebsiteDataFromUrl($(this).val())" class="form-control" name="inputLink" id="inputLink" placeholder="Link to the original post or source url">
								</div>
								...
								<div class="form-group">
									...
									<input type="file" <?php echo $settings['bulk_upload'] ? 'multiple' : '' ?> id="inputfile[]" name="inputfile[]" class="filestyle" data-iconName="glyphicon-picture" data-buttonText="Select Image">
								</div>

								<div class="form-group" id="fetch-image">
