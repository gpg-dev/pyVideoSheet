<?php include("header.php");?>
	...
	<section class="col-md-10">
		...
		<div class="page-header">
			<h3>Pending Posts <small>Manage pending posts</small></h3>
		</div>
...
//Desapprove
		...
		<section class="col-md-12">
			...
			$q= $mysqli->query("SELECT * FROM posts WHERE active=0 ORDER BY id DESC limit $start,$limit");
			...
			<table class="table table-bordered">
				...
				while($Row=mysqli_fetch_assoc($q)){
					...
					<tr class="btnDelete" data-id="<?php echo $Row['id'];?>">
						<td><a href="../post-<?php echo $Row['id'];?>-<?php echo $PageLink;?>.html" target="_blank">
...
<!--							<button class="btn btn-info btnDisapprove">Approve</button>-->
							<a class="btn btn-success btnEdit" href="edit_post.php?id=<?php echo $Row['id'];?>">Approve</a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<p class="text-info"><small>You can disapprove this post by navigating to Posts > Approved Posts.</small></p>
						</div>
						<!--/modal-body-collapse -->
						<div class="modal-footer">
