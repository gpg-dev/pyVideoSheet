					...
					<div class="panel-body">
						...
						<ul>
							...
							if($TotalPostHits = $mysqli->query("SELECT SUM(hits) AS Hits FROM posts")){
								...
								?>
								<li class="fa <?php echo $faIcon['view'] ?>"><span>Total Number Post Views: <?php echo $NumberPostHits['Hits'];?></span></li>
								<?php
							...
							if($TotalUsers = $mysqli->query("SELECT id FROM posts WHERE active=1")){
								...
								<li class="fa <?php echo $faIcon['view'] ?>"><span>Total Number of Users: <?php echo $NumberofUsers;?></span></li>
						...
						while($AppRow = mysqli_fetch_assoc($DisplayApproved)){
							...
							<tr>
								<td><a href="../post-<?php echo $AppRow['id'];?>-<?php echo $AppPostLink;?>.html" target="_blank">
										<img src="timthumb.php?src=http://<?php echo str_replace('http://', '', $SiteLink);?>uploaded_images/<?php echo $AppRow['image'];?>&amp;h=50&amp;w=50&amp;q=100" alt="<?php echo $AppLongTitle;?>" class="img-responsive">
									</a></td>
