			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form id="settingsForm" action="update_settings.php" enctype="multipart/form-data" method="post">
						...
						<div class="form-group">
							<label for="inputVersion">Website Version</label>
							<div class="input-group">
								<span class="input-group-addon"><span class="glyphicon fa  fa-info"></span></span>
								<input type="text" id="inputVersion" name="inputVersion" class="form-control" placeholder="Enter your site version here" value="<?php echo $SettingsRow['build_version']?>">
							</div>
						</div>
						...
						<div class="row">
								...
								<div class="input-group">
									...
									<select class="form-control" id="inputTemplate" name="inputTemplate">
										...
										foreach(glob('../templates/*', GLOB_ONLYDIR) as $dir) {
											...
											?>
											<option value="<?php echo $TemplateDir;?>" <?php if ($SettingsRow['template'] == $TemplateDir) echo 'selected="selected"' ?>>
							...
							<div class="col-xs-6">
								<label for="inputBulkUpload">Upload Bulk Image</label>
								<div class="input-group">
									<span class="input-group-addon"><span class="fa fa-check"></span></span>
									<select class="form-control" id="inputBulkUpload" name="inputBulkUpload">
										<option value="1" <?php echo @$SettingsRow['bulk_upload'] ? 'selected' : '' ?>>ON</option>
										<option value="0" <?php echo !@$SettingsRow['bulk_upload'] ? 'selected' : '' ?>>OFF</option>
									</select>
								</div>
