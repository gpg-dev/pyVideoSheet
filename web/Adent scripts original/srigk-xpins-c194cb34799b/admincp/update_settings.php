...
if($_POST)
{
	...
	$version		    = $mysqli->escape_string($_POST['inputVersion']);
	$bulkUpload		    = $mysqli->escape_string($_POST['inputBulkUpload']);
...
// Insert info into database table.. do w.e!
			...
			$updateQuery = $buildQueryUpdateFromArray($dataSave);
			$sql = "UPDATE settings SET $updateQuery WHERE id=1";
			$mysqli->query($sql);
