...
<div class="page-title"><h1><?php echo $CNRow['cname'];?> Gallery</h1></div>

<?php include 'filter.php'; ?>
<div style="clear: both;"></div>
<div id="content" class="pull-container" style="top: 0 !important;">

	<?php

	$query = $sqlGetProduct("catid=$cid", 'categories.id');
