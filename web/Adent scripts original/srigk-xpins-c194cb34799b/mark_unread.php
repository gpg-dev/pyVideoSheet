...
if($MsgByid==$Uid){
	$mysqli->query("UPDATE pms SET from_read=0 WHERE  pm_id='$GetPm'");
	}else{
	$mysqli->query("UPDATE pms SET to_read=0 WHERE  pm_id='$GetPm'");	
}
...
?>
<script>
$("#freeow").freeow("Oki..", "Conversation marked as unread", {
classes: ["smokey"],
autoHide: true
});
</script>
