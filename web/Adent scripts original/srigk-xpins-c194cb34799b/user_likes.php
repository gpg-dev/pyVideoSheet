...
<div class="page-title"><h1><?php echo ucfirst($ThisUserRow['username']);?> Like Gallery</h1></div>

<div id="content" class="pull-container">

	<?php

	$result = $mysqli->query("SELECT * FROM favip LEFT JOIN posts ON favip.postid=posts.id $sqlLeftJoinCategoryPost WHERE favip.uid=$upid ORDER BY favip.id DESC LIMIT 0, 20");
...
<nav id="page-nav">
	<a href="data_user_likes.php?id=<?php echo $upid;?>&page=2"></a>
</nav>
