...
schema.virtual('fileUrl')
  .get(() => (this.filePath ? Helper.App.getPublicFileUrl(this.filePath) : this.originalPath));

schema.virtual('mediumUrl')
  .get(() => Helper.App.getPublicFileUrl(this.mediumPath));

schema.virtual('thumbUrl')
  .get(() => Helper.App.getPublicFileUrl(this.thumbPath));
