...
export class AuthService {
  ...
  update(params: any): Promise<any> {
    return this.restangular.all('users').customPUT(params).toPromise();
  }
  ...
  changePhone(params: any) {
    return this.restangular.all('phone').customPUT(params).toPromise();
  }
  
  verifyPhone(params: any): Promise<any> {
    return this.restangular.all('phone/verify').post(params).toPromise();
  }
